...
def test_net(sess, net, imdb, weights_filename, test_file, testset, method, max_per_image=100, thresh=0.5):
  ...
  # timers
  _t = {'calculate_AP' : Timer(), 'misc' : Timer()}
  ...
  for i in range(num_images):
    ...
    print('calculate_AP: {:d}/{:d} {:.3f}s {:.3f}s' \
        .format(i + 1, num_images, _t['calculate_AP'].average_time,
